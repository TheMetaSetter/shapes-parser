...
public:
    /**
     * @brief Perform sorting shapes by criteria.
     * 
     * @param shapes is the vector of shapes to sort.
     * @param criteria is the criteria to sort. Can be found in "Criteria" class.
     */
